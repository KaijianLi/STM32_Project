...
unsigned char MPU_Write_Len(uint8_t addr,uint8_t reg,uint8_t len,uint8_t *buf);//IIC连续写
unsigned char MPU_Read_Len(uint8_t addr,uint8_t reg,uint8_t len,uint8_t *buf); //IIC连续读
unsigned char MPU_Write_Byte(uint8_t reg,uint8_t data);				//IIC写一个字节
unsigned char MPU_Read_Byte(uint8_t reg);						//IIC读一个字节
...
unsigned char MPU_Set_Fifo(uint8_t sens);
