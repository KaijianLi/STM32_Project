...
int main(void)
{
  ...
  while (1)
  {
    ...
    {
      float x_point = 2 * PI / 100 * i;
      float y1_point = sin(x_point);
      float y2_point = cos(x_point);
      float y3_point = tan(x_point);
      printf("y_point is :%f,%f,%f\n",y1_point,y2_point,y3_point);
      HAL_Delay(10);
    }
  }
  /* USER CODE END 3 */
